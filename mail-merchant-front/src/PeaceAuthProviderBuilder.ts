...
type PeaceAuthProviderBuilderProps = {
  url: string,
  httpClient?: HttpClient
}

export const PeaceAuthProviderBuilder = (props: PeaceAuthProviderBuilderProps): AuthProvider => {
  const {url, httpClient = fetch} = props;
  return {
    login: (params) => {
